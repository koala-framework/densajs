Ext4.define('Densa.grid.controller.EditWindow', {
    mixins: {
    ...
    init: function()
    {
        ...
        if (!(this.editWindowController instanceof Densa.editWindow.WindowController)) Ext4.Error.raise('editWindowController config needs to be a Densa.editWindow.WindowController');
